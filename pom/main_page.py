...
class MainPage:
    def __init__(self, page):
        ...
        self.mediahuisProjectLink = page.locator('#projects').get_by_role('link').first
        ...
        self.iOProjectLink = page.locator('#projects').get_by_role('link').nth(1)
        ...
        self.responsumProjectLink = page.locator('#projects').get_by_role('link').nth(2)
